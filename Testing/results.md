...
Note: SLAAC Addresses will be assigned to any interface connected to a router sending advertisements and also configured to receive advertisements.  This resulted in the R660 getting 2 SLAAC IPv6 Addresses, one for each active 100G NIC.  Either one of these could be used for bootstrap process.
